---
description: Veille deal sourcing complète (5 flux) sur le périmètre B&Capital
---
...
3. Couvre les 5 flux :
   ...
   E. Signaux marché / levées structurantes (fonds mid-market, secondaire / continuation)
...
7. Journalise : deals -> journal-deals.md ; manqués -> deals-manques.md ;
   mercato / normes / signaux marché -> mercato-normes.md.
